...
\begin{figure}[H]
\includegraphics[scale=0.48]{Sreenshots/PSoC_TopDesign_X_Y.png}
...
\begin{figure}[H]
\includegraphics[scale=0.7]{Sreenshots/ADC_SAR_SEQ.png}
...
\begin{figure}[H]
\includegraphics[scale=0.22]{Sreenshots/PSoC_X_Y_pin_configuration.png}
...
\begin{figure}[H]
\includegraphics[scale=0.75]{Sreenshots/ULN2003AN_board.png}
...
\begin{figure}[H]
\includegraphics[scale=0.068]{Sreenshots/x_sensor_start.jpg}
...
\begin{figure}[H]
\includegraphics[scale=0.068]{Sreenshots/y_sensor_start.jpg}
...
\begin{figure}[H]
\includegraphics[scale=0.068]{Sreenshots/End_of_search.jpg}
...
\begin{figure}[H]
\includegraphics[scale=1]{Sreenshots/Sensor-uden-genstand.png}
...
\begin{figure}[H]
\includegraphics[scale=1]{Sreenshots/Sensor-12cm.png}
\caption{Afstandsmåling ved 12 cm}
\label{Sensor_12cm}
\end{figure}

\begin{figure}[H]
\includegraphics[scale=1]{Sreenshots/Sensor-22cm.png}
