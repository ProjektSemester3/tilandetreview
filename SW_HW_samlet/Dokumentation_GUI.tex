...
\begin{figure}[H]
	\includegraphics[scale=1]{tex/Test/GUI-Test/Billeder/Test_Virtuel_klasse_nobottle}
	\caption{Test at virtuel klasse}
\end{figure}

\begin{figure}[H]
	\includegraphics[scale=1]{tex/Test/GUI-Test/Billeder/Test_Virtuel_klasse_Valid}
	\caption{Test at virtuel klasse}
\end{figure}
