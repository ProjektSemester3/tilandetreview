...
\begin{figure}[H]
	\centering
\includegraphics[scale=0.5]{Screenshots/Terminal_spi_slave}
...
\begin{figure}[H]
	\centering
\includegraphics[scale=0.3]{Screenshots/Logic_analyzer}
...
\begin{figure}[H]
	\centering
\includegraphics[scale=0.5]{Screenshots/Analog_devkit_echo_psoc_1}
...
\begin{figure}[H]
	\centering
\includegraphics[scale=0.5]{Screenshots/Analog_cat_psoc_5}
