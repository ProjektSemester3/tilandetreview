...
\begin{figure}[H]
\includegraphics[scale=0.9]{Screenshots/Realisering_devkit_psoc}
...
\begin{figure}[H]
\includegraphics[scale=0.1]{Screenshots/Logic_analyzer}
...
\begin{figure}[H]
\includegraphics[scale=0.1]{Screenshots/Terminal_spi_slave}
...
\begin{figure}[H]
\includegraphics[scale=0.1]{Screenshots/Analog_devkit_echo_psoc_1}
...
\begin{figure}[H]
\includegraphics[scale=0.1]{Screenshots/Analog_cat_psoc_5}
